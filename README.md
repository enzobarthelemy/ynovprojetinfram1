...
2. Mise en place de la CI/CD (prérequis, une seule fois)
	...
	2. Buckets d'assets CDK (à la place du bootstrap) : ynov-cdk-assets-<ACCOUNT_ID>-use1 (us-east-1) et -usw2 (us-west-2). Localisation de tous les templates JSON deployé.
...
Les stages et leur rôle :
	...
	- seed-west-db : restauSre une base en us-west-2 depuis un snapshot de la primaire (us-west-2 devient actif).
...
Configuration du miroir (une seule fois) :
	...
	2. Côté GitLab : Settings → Repository → Mirroring repositories.
		- Git repository URL :Example: https://github.com/enzobarthelemy/ynovprojetinfram1.git
