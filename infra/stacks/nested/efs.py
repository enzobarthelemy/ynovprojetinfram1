...
class EfsNested(NestedStack):
    """
    EFS independant par region (CfnFileSystem L1).
    - Resilience intra-region 1a/1b : native (mount targets dans les 2 AZ, meme filesystem).
    - DR cross-region : geree par un job AWS Backup separe (pas de replication native ici).
    Expose file_system_id.
    """

    def __init__(self, scope: Construct, construct_id: str, *,
                 web_subnet_ids: list, efs_sg_id: str, name: str, **kwargs) -> None:
